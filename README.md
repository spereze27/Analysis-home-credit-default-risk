...
* Manejo de valores faltantes: Se procede a determinar el porcentaje de valores faltantes en cada columna, se va a realizar el conteo de valores faltantes y se expresara como un porcentaje del total, despues se mostrata la distribucion de valores faltantes en las columnas y en base a esta informacion se procedera a definir el Umbral de imputacion, despues en las columnas restantes se reemplazaran los valores faltante por la media de dicha columna
